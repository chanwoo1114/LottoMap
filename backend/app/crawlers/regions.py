...
SIDO_LIST: list[str] = list(REGIONS.keys())

ALL_REGION_PAIRS: list[tuple[str, str]] = [
    (sido, sigungu)
    for sido, sigungus in REGIONS.items()
