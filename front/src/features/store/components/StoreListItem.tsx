...
import {FavoriteButton} from "@/features/store/components/FavoriteButton.tsx";
...
export function StoreListItem({ store, selected, onSelect, onRequireLogin }: StoreListItemProps) {
  ...
  return (
    <div className={cn(
      'flex items-center gap-1 border-l-2 pl-3 pr-2 py-2 transition-colors hover:bg-gray-50',
